;( function( $ ) {
	//customize width height iframe
	var width_fr = jQuery( '.frame-film').width();
	var width_film = jQuery( '.frame-film iframe').width();
	var height_film = jQuery( '.frame-film iframe').height();
	var num_times= width_fr/width_film;
	jQuery( '.frame-film iframe').width(width_film*num_times);
	jQuery( '.frame-film iframe').height(height_film*num_times);
	//end cus
	"use strict";
