 ...
 * @since 1.0.0
 */
class Trade_line_Footer_Widgets{
	 ...
	 * @var int
	 */
	protected $theme_prefix = 'trade_line';
	...
	function footer_widgets_init() {
		...
		for ( $i = 1; $i <= $this->max_widgets; $i++ ) {
			register_sidebar( array(
				'name'          => sprintf( __( 'Footer Widget %d', 'trade-line' ), $i ),
...
// Initialize.
$trade_line_footer_widgets = new Trade_line_Footer_Widgets();
